...
import dev.kryptic.module.combat.AutoAnchorModule;
import dev.kryptic.module.combat.AutoCrystalModule;
import dev.kryptic.module.combat.AutoTotemModule;
import dev.kryptic.module.combat.CrystalOptimiserModule;
import dev.kryptic.module.combat.DoubleAnchorModule;
import dev.kryptic.module.combat.SafeAnchorModule;
...
public class ModuleManager {
   ...
   public AutoAnchorModule autoAnchor;
   public DoubleAnchorModule doubleAnchor;
   public SafeAnchorModule safeAnchor;
   public CrystalOptimiserModule crystalOptimiser;
   ...
   private void registerPlaceholders() {
      ...
      this.register(this.safeAnchor = new SafeAnchorModule());
      this.register(this.autoAnchor = new AutoAnchorModule());
      this.register(this.doubleAnchor = new DoubleAnchorModule());
      this.register(this.crystalOptimiser = new CrystalOptimiserModule());
