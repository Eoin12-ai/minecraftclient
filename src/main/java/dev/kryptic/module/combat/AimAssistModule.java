...
import dev.kryptic.module.AimAssistCompute;
...
public class AimAssistModule extends Module {
   private static final Logger LOG = LoggerFactory.getLogger("KrypticClient/AimAssist");
   ...
   public double[] computePixels(double d, double coord, double currentScore) {
      return this.logic == null ? null : this.logic.computePixels(this, d, coord, currentScore);
   }
}
