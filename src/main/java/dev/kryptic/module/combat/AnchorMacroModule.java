   ...
   public void onTick() {
      ...
      if (client.player != null && client.interactionManager != null && client.world != null) {
         if (this.step > 0) {
            ...
            boolean pressed = GLFW.glfwGetMouseButton(l, 1) == 1;
            if (pressed && client.crosshairTarget != null && client.crosshairTarget.getType() == Type.BLOCK) {
      ...
      switch (this.step) {
         ...
         case 2:
            if (this.tickCounter >= this.glowstoneDelay.getInt()) {
               if (blockHit != null && this.targetPos.equals(blockHit.getBlockPos())) {
