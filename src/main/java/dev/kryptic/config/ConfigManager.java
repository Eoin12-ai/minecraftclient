...
public class ConfigManager {
   ...
   private static final Map<String, String> LEGACY_SETTINGS = Map.ofEntries(
         ...
         Map.entry("Storage ESP/Box Style", "Mode"),
         Map.entry("Storage ESP/Reach", "Range"),
         Map.entry("Storage ESP/Box Opacity", "Highlight Alpha"),
         Map.entry("Storage ESP/Guide Lines", "Tracers"),
         Map.entry("Storage ESP/Container Types", "Containers"),
         Map.entry("Storage ESP/Skip Looted", "Hide Opened"),
