...
public final class JumpCircleRenderer {
   private static final Identifier TEXTURE_MARK = Identifier.of("krypticclient", "textures/misc/mark.png");
   private static final Identifier TEXTURE_RING = Identifier.of("krypticclient", "textures/misc/ring.png");
   ...
   public static void render(Immediate immediate, MatrixStack matrices, Vec3d vec, JumpCirclesModule jumpCirclesModule) {
      ...
      if (!deque.isEmpty()) {
         ...
         if (!deque.isEmpty()) {
            ...
            VertexConsumer consumer = immediate.getBuffer(net.minecraft.client.render.RenderLayers.entityTranslucentEmissive(TEXTURE_MARK));
