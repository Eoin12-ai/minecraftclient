...
import dev.kryptic.config.ConfigManager;
import dev.kryptic.config.ConfigStore;
import dev.kryptic.config.ServerConfigs;
import dev.kryptic.gui.ClickGuiScreen;
...
import dev.kryptic.wm.Seed;
public class KrypticClient implements ClientModInitializer {
   public static final String MOD_ID = "krypticclient";
   public static final String NAME = "Kryptic Client";
   public static final String VERSION = "1.6.2";
   public static final Logger LOGGER = LoggerFactory.getLogger("KrypticClient");
   ...
   public void onInitializeClient() {
      Seed.check();
      LOGGER.info("{} {} initializing", "KrypticClient", "1.6.2");
