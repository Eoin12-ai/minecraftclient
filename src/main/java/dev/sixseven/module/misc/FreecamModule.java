...
public class FreecamModule extends Module {
   ...
   private void mergeLatchFromAutoWalk() {
      AutoWalkModule autoWalkModule = SixSevenClient.modules() != null ? SixSevenClient.modules().autoWalk : null;
   ...
   public static void reapplyBodyInput(MinecraftClient client) {
      ...
      if (freecamModule != null && freecamModule.isActive() && client.player != null) {
         ...
         ((ClientInputAccessor)player.input).sixsevenclient$setMoveVector(vec2f);
