...
public final class DiscordPresenceService {
    ...
    public synchronized void start(String applicationId) {
        ...
        if (running) return;
        running = true;
        worker = new Thread(this::run, "epsteinclient-discord-rpc");
    ...
    private void tickConnection() throws Exception {
        ...
        if (ipc == null) {
            ...
            if (ipc == null) {
                ...
                if (!loggedFailure) {
                    SixSevenClient.LOGGER.info("Discord presence: no Discord client responding, will keep retrying");
                    loggedFailure = true;
                }
                return;
            }
            ...
            loggedFailure = false;
            lastSent = null;
            SixSevenClient.LOGGER.info("Discord presence: connected");
        }
