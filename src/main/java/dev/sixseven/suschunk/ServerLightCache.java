            ...
            if (b != null && b.length == 2048 && n14 >= TARGET_MIN_SECTION && n14 <= TARGET_MAX_SECTION) {
               ...
               if (DEBUG_LOG && n15 > 0) {
                  SixSevenClient.LOGGER
                     .info("(_=\u001d?ÃÂ¨ÃÂ¥\u008dÃÂ¡ÃÂÃÂ´ÃÂÃÂ°ÃÂÃÂ°ÃÂÃÂ·ÃÂÃÂÃÂÃÂ´ÃÂÃÂÃÂÃÂ ÃÂÃÂÃÂÃÂÃÂÃÂ¯ÃÂ\u03a2ÃÂÃÂÃÂ¢ÃÂÃÂªÃÂÃÂ£ÃÂªÃÂ´ÃÂÃÂ´\u0557ÃÂ\u05cdÃÂ²ÃÂÃÂ¡\u0605ÃÂ°", new Object[]{n, n14, n10, n15});
               }
