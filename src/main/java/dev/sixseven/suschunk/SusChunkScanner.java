...
public class SusChunkScanner {
   ...
   private SusChunkScanner.ChunkScore scanChunk(MinecraftClient client, WorldChunk chunk) {
      ...
      if (DEBUG_LOG && chunkKey2.coord > 0.0) {
         SixSevenClient.LOGGER.info("(_=\u001dOÃÂ¤ÃÂ¯\u0082ÃÂ¼ÃÂÃÂÃÂÃÂ¸ÃÂÃÂ³ÃÂÃÂ½ÃÂÃÂÃÂÃÂ¡ÃÂÃÂÃÂÃÂ³ÃÂÃÂÃÂÃÂÃÂÃÂ¨", new Object[]{chunk.getPos(), chunkKey2.coord, chunkKey2.hits});
      }
   ...
   private void inspectPlant(MinecraftClient client, BlockState state, BlockPos pos, SusChunkScanner.ChunkScore chunkScore) {
      ...
      if ((block == Blocks.KELP || block == Blocks.KELP_PLANT) && this.module.kelp.get()) {
         ...
         if (matches && n >= 8 || n >= 14) {
            ...
            if (DEBUG_LOG) {
               SixSevenClient.LOGGER.info("(_=\u001dOÃÂ¤\u0087ÃÂ¯\u0085ÃÂ«ÃÂÃÂ£ÃÂ¸ÃÂÃÂ³ÃÂÃÂ»ÃÂÃÂÃÂÃÂ¨ÃÂÃÂÃÂÃÂ»ÃÂÃÂÃÂÃÂ ÃÂÃÂ°ÃÂ\u03a2ÃÂ", new Object[]{pos, n, matches});
            }
         }
         ...
         if (localZ >= 12) {
            ...
            if (DEBUG_LOG) {
               SixSevenClient.LOGGER.info("(_=\u001dOÃÂ¤\u008eÃÂ«\u0084ÃÂ¹ÃÂ¦ÃÂ¬ÃÂ£ÃÂ°ÃÂ¨ÃÂÃÂ¾ÃÂÃÂÃÂÃÂ»ÃÂÃÂÃÂÃÂ ÃÂ", pos, localZ);
            }
         }
         ...
         if (state.contains(Properties.AGE_3) && (Integer)state.get(Properties.AGE_3) == 3) {
            ...
            if (DEBUG_LOG) {
               SixSevenClient.LOGGER.info("(_=\u001dOÃÂ¤\u008eÃÂ¯\u009bÃÂ©ÃÂ ÃÂ¦ÃÂÃÂÃÂ¾ÃÂÃÂ¦ÃÂÃÂÃÂÃÂ¹ÃÂÃÂµÃÂÃÂ¦", pos);
            }
         }
         ...
         if (localY >= 7) {
            ...
            if (DEBUG_LOG) {
               SixSevenClient.LOGGER.info("(_=\u001dOÃÂ¤\u009aÃÂ£\u0087ÃÂ¾ÃÂºÃÂÃÂÃÂÃÂ®ÃÂÃÂ¶ÃÂÃÂÃÂÃÂ¡ÃÂÃÂ", pos, localY);
            }
         }
